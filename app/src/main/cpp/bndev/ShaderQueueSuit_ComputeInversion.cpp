...
void ShaderQueueSuit_ComputeInversion::create_pipeline_layout(VkDevice& device)
{
	...
	push_constant_ranges[0].size = sizeof(float) * 3;
...
void ShaderQueueSuit_ComputeInversion::destroy_pipeline_layout(VkDevice& device)
{
	vk::vkDestroyPipelineLayout(device, pipelineLayout, NULL);
}


void ShaderQueueSuit_ComputeInversion::init_descriptor_set(VkDevice& device)
{
	...
	type_count[4].type = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
...
void ShaderQueueSuit_ComputeInversion::create_shader(VkDevice& device)
{
	std::string compStr = FileUtil::loadAssetStr("shader/Inversion.comp");//加载计算着色器脚本
...
void ShaderQueueSuit_ComputeInversion::destroy_shader(VkDevice& device)
{
	vk::vkDestroyShaderModule(device, shaderStages[0].module, NULL);
}

void ShaderQueueSuit_ComputeInversion::create_pipe_line(VkDevice& device)
{
...
void ShaderQueueSuit_ComputeInversion::destroy_pipe_line(VkDevice& device)
{
...
ShaderQueueSuit_ComputeInversion::ShaderQueueSuit_ComputeInversion(VkDevice* deviceIn, VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_ComputeInversion::~ShaderQueueSuit_ComputeInversion()
{
