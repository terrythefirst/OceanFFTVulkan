...
void ShaderQueueSuit_ComputeHkt::create_uniform_buffer(VkDevice& device, VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
void ShaderQueueSuit_ComputeHkt::destroy_uniform_buffer(VkDevice& device)
{
...
void ShaderQueueSuit_ComputeHkt::create_pipeline_layout(VkDevice& device)
{
	...
	push_constant_ranges[0].size = sizeof(int) * 2;
...
void ShaderQueueSuit_ComputeHkt::destroy_pipeline_layout(VkDevice& device)
{
	vk::vkDestroyPipelineLayout(device, pipelineLayout, NULL);
}


void ShaderQueueSuit_ComputeHkt::init_descriptor_set(VkDevice& device)
{
...
void ShaderQueueSuit_ComputeHkt::create_shader(VkDevice& device)
{
	std::string compStr = FileUtil::loadAssetStr("shader/hkt.comp");//加载计算着色器脚本
...
void ShaderQueueSuit_ComputeHkt::destroy_shader(VkDevice& device)
{
	vk::vkDestroyShaderModule(device, shaderStages[0].module, NULL);
}

void ShaderQueueSuit_ComputeHkt::create_pipe_line(VkDevice& device)
{
...
void ShaderQueueSuit_ComputeHkt::destroy_pipe_line(VkDevice& device)
{
...
ShaderQueueSuit_ComputeHkt::ShaderQueueSuit_ComputeHkt(VkDevice* deviceIn, VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_ComputeHkt::~ShaderQueueSuit_ComputeHkt()
{
